...
| path             | method | authen?                                    | validate?       | params  | req.body                                                                                                                                                                                                                                                              | status code | res                                                                   | remark |
| ---------------- | ------ | ------------------------------------------ | --------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------- | ------ |
| /                | POST   | agent                                      | validate (joi)  | ---     | {nameTh, nameEn, location (address), district, province, lat, long, utilities, roomNumber, roomSize, Floor, Building, isAvailable, price, description, condoImage: [imageFiles], roomImages: [imageFiles], roomImageList: [{id, url, file?}], roomUtilList: [utilId]} | 201         | {id: postId, req.body}                                                |        |
