...
| /profile         | PATCH  | authenticate | username, email, mobile | ---    |          | 200         | {editedUser} |        |
...
| /:postId/condo/:condoId/room/:roomId | PATCH  | agent, post/condo/room existed?, agent ต้องมี postId | validate (joi)  | postId, condoId, roomId | ""                                                                                                                                                                                                                                                                 | 200         | {id: postId, req.body}                                                         |        |
